...
class CloseSessionInputContent(QDMNodeContentWidget):
    def initUI(self):
...
@register_node(OP_Node_CLOSE_SESSION)
class ProcessNode_CloseSession(ProcessNode):
    icon = ""
    op_code = OP_Node_CLOSE_SESSION
    op_title = "Close Session"
    content_label = ""
    ...
    def initInnerClasses(self):
        self.content = CloseSessionInputContent(self)
