...
class FETCH_EmailInputContent(QDMNodeContentWidget):
    def initUI(self):
        ...
        # self.edit.setMaximumSize(155,20)
...
@register_node(OP_Node_FETCH_EMAIL)
class ProcessNode_FetchEmail(ProcessNode):
    icon = ""
    op_code = OP_Node_FETCH_EMAIL
    op_title = "Fetch Email"
    content_label = ""
    ...
    def initInnerClasses(self):
        self.content = FETCH_EmailInputContent(self)
