...
class LoopEndInputContent(QDMNodeContentWidget):
    def initUI(self):
...
@register_node(OP_Node_Loopend)
class ProcessNode_LoopEnd(ProcessNode):
    icon = ""
    op_code = OP_Node_Loopend
    op_title = "Loop end"
    content_label = ""
    ...
    def initInnerClasses(self):
        self.content = LoopEndInputContent(self)
