...
class LoopStartInputContent(QDMNodeContentWidget):
    def initUI(self):
...
@register_node(OP_Node_Loopstart)
class ProcessNode_Loopstart(ProcessNode):
    icon = ""
    op_code = OP_Node_Loopstart
    op_title = "Loop start"
    content_label = ""
    ...
    def __init__(self, scene):
        ...
        self.eval()
        # ProcessNode.height=50

    def initInnerClasses(self):
        self.content = LoopStartInputContent(self)
        self.grNode = ProcessGraphicsNode(self)
        # print("height is", self.grNode.height)
        # self.grNode.height=50
        # print("height is", self.grNode.height)
