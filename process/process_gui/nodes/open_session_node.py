...
class OpenSessionInputContent(QDMNodeContentWidget):
    def initUI(self):
...
@register_node(OP_Node_OPEN_SESSION)
class ProcessNode_OpenSession(ProcessNode):
    icon = ""
    op_code = OP_Node_OPEN_SESSION
    op_title = "Open Session"
    content_label = ""
    ...
    def initInnerClasses(self):
        self.content = OpenSessionInputContent(self)
