...
class TypeInputContent(QDMNodeContentWidget):
    def initUI(self):
...
@register_node(OP_NODE_TYPE)
class ProcessNode_Type(ProcessNode):
    icon = ""
    op_code = OP_NODE_TYPE
    op_title = "Type"
    content_label = ""
    ...
    def initInnerClasses(self):
        self.content = TypeInputContent(self)
