...
var flow_path = 'C:/Users/Admin/Documents/SendMail';

casper.start('about:blank', function() {
techo('about:blank' + ' - ' + this.getTitle() + '\n');});

var home_path = 'C:/Users/Admin';

var desktop_path = 'C:/Users/Admin/Desktop';

var temp_path = 'C:/Users/Admin/AppData/Local/Temp';
...
casper.then(function() {{techo('vision ocr_text = input(email," ",u"\\u0050\\u006c\\u0065\\u0061\\u0073\\u0065\\u0020\\u0065\\u006e\\u0074\\u0065\\u0072\\u0020\\u0045\\u006d\\u0061\\u0069\\u006c",False)\ntagui_text = open(\'tagui.sikuli/tagui_sikuli.txt\',\'w\')\ntagui_text.write(ocr_text.decode(\'utf8\')); tagui_text.close()'); var fs = require('fs');
if (!sikuli_step('vision ocr_text = input(email," ",u"\\u0050\\u006c\\u0065\\u0061\\u0073\\u0065\\u0020\\u0065\\u006e\\u0074\\u0065\\u0072\\u0020\\u0045\\u006d\\u0061\\u0069\\u006c",False)\ntagui_text = open(\'tagui.sikuli/tagui_sikuli.txt\',\'w\')\ntagui_text.write(ocr_text.decode(\'utf8\')); tagui_text.close()')) if (!fs.exists('for vision step'))
...
casper.then(function() {{techo('vision ocr_text = input(subject," ",u"\\u0050\\u006c\\u0065\\u0061\\u0073\\u0065\\u0020\\u0065\\u006e\\u0074\\u0065\\u0072\\u0020\\u0073\\u0075\\u0062\\u006a\\u0065\\u0063\\u0074",False)\ntagui_text = open(\'tagui.sikuli/tagui_sikuli.txt\',\'w\')\ntagui_text.write(ocr_text.decode(\'utf8\')); tagui_text.close()'); var fs = require('fs');
if (!sikuli_step('vision ocr_text = input(subject," ",u"\\u0050\\u006c\\u0065\\u0061\\u0073\\u0065\\u0020\\u0065\\u006e\\u0074\\u0065\\u0072\\u0020\\u0073\\u0075\\u0062\\u006a\\u0065\\u0063\\u0074",False)\ntagui_text = open(\'tagui.sikuli/tagui_sikuli.txt\',\'w\')\ntagui_text.write(ocr_text.decode(\'utf8\')); tagui_text.close()')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});
...
casper.then(function() {{techo('vision ocr_text = input(message," ",u"\\u0050\\u006c\\u0065\\u0061\\u0073\\u0065\\u0020\\u0065\\u006e\\u0074\\u0065\\u0072\\u0020\\u006d\\u0065\\u0073\\u0073\\u0061\\u0067\\u0065",False)\ntagui_text = open(\'tagui.sikuli/tagui_sikuli.txt\',\'w\')\ntagui_text.write(ocr_text.decode(\'utf8\')); tagui_text.close()'); var fs = require('fs');
if (!sikuli_step('vision ocr_text = input(message," ",u"\\u0050\\u006c\\u0065\\u0061\\u0073\\u0065\\u0020\\u0065\\u006e\\u0074\\u0065\\u0072\\u0020\\u006d\\u0065\\u0073\\u0073\\u0061\\u0067\\u0065",False)\ntagui_text = open(\'tagui.sikuli/tagui_sikuli.txt\',\'w\')\ntagui_text.write(ocr_text.decode(\'utf8\')); tagui_text.close()')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});
...
casper.then(function() {{techo('py SendMail(\'smtp.gmail.com\',587,\'dummytestrpa@gmail.com\',\'abcd@1234\',email,\'\',\'\',subject,message,\'\')');
py_result = ''; if (!py_step('py SendMail(\'smtp.gmail.com\',587,\'dummytestrpa@gmail.com\',\'abcd@1234\',email,\'\',\'\',subject,message,\'\')'))
...
casper.then(function() {{techo('vision popup(u"\\u0050\\u0072\\u006f\\u0063\\u0065\\u0073\\u0073\\u0020\\u0063\\u006f\\u006d\\u0070\\u006c\\u0065\\u0074\\u0065\\u0064",u"\\u004d\\u006f\\u0078\\u0069\\u0065\\u0020\\u0052\\u0050\\u0041")'); var fs = require('fs');
if (!sikuli_step('vision popup(u"\\u0050\\u0072\\u006f\\u0063\\u0065\\u0073\\u0073\\u0020\\u0063\\u006f\\u006d\\u0070\\u006c\\u0065\\u0074\\u0065\\u0064",u"\\u004d\\u006f\\u0078\\u0069\\u0065\\u0020\\u0052\\u0050\\u0041")')) if (!fs.exists('for vision step'))
this.echo('ERROR - cannot find image file for vision step').exit(); else
this.echo('ERROR - cannot find for vision step on screen').exit(); this.wait(0);}});
