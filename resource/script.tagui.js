...
var flow_path = 'C:/Users/Accubits/PycharmProjects/RPABot/resource';

var home_path = 'C:/Users/Accubits';

var desktop_path = 'C:/Users/Accubits/Desktop';

var temp_path = 'C:/Users/Accubits/AppData/Local/Temp';
...
chrome_step('Page.navigate',{url: 'https://stackoverflow.com/'}); sleep(1000);
techo('https://stackoverflow.com/' + ' - ' + chrome.getTitle() + '\n');});

casper.then(function() {{techo('click /html/body/div[4]/div[1]/div[1]/nav/ol/li[2]/ol/li[2]/a/span');
casper.waitFor(function check() {return check_tx('/html/body/div[4]/div[1]/div[1]/nav/ol/li[2]/ol/li[2]/a/span');},
function then() {chrome.click(tx('/html/body/div[4]/div[1]/div[1]/nav/ol/li[2]/ol/li[2]/a/span'));},
function timeout() {this.echo('ERROR - cannot find /html/body/div[4]/div[1]/div[1]/nav/ol/li[2]/ol/li[2]/a/span').exit();});}});

casper.then(function() {{techo('read //*[@id="question-summary-63394914"] to readmsg');
casper.waitFor(function check() {return check_tx('//*[@id="question-summary-63394914"]');},
function then() {readmsg = chrome.fetchText(tx('//*[@id="question-summary-63394914"]')).trim();},
function timeout() {this.echo('ERROR - cannot find //*[@id="question-summary-63394914"]').exit();});}});

casper.then(function() {this.echo(readmsg);});

casper.then(function() { // start of JS code
py_step('readmsg = "' + readmsg + '"')
}); // end of JS code

casper.then(function() {{techo('py read_info(readmsg)');
py_result = ''; if (!py_step('py read_info(readmsg)'))
