...
var flow_path = 'C:/Users/DELL/PycharmProjects/ProcessBudDevBranch/resource';

var home_path = 'C:/Users/DELL';

var desktop_path = 'C:/Users/DELL/Desktop';
...
chrome_step('Page.navigate',{url: 'https://www.test.com/'}); sleep(1000);
techo('https://www.test.com/' + ' - ' + chrome.getTitle() + '\n');});

casper.then(function() {techo('Wait 2');});
casper.then(function() {casper.wait(2000, function() {});});

casper.then(function() {{techo('Read /html/body/article/div/section/div/div[3]/p to test');
casper.waitFor(function check() {return check_tx('/html/body/article/div/section/div/div[3]/p');},
function then() {test = chrome.fetchText(tx('/html/body/article/div/section/div/div[3]/p')).trim();},
function timeout() {this.echo('ERROR - cannot find /html/body/article/div/section/div/div[3]/p').exit();});}});

casper.then(function() {this.echo(test);});
