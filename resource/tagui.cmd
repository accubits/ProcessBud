...
if exist "tagui_py\tagui_py.in" (
        start /min cmd /c py -u tagui_py\tagui_py.py 2^>^&1 ^| tee -a tagui_py\tagui_py.log
)
...
if exist "tagui.sikuli\tagui_sikuli.in" (
	...
	start /min cmd /c openjdk\bin\java -jar sikulix\sikulix.jar -r tagui.sikuli -d 3 2^>^&1 ^| tee -a tagui.sikuli\tagui.log
)
