...
def output_sikuli_text ( output_text ):
	import codecs
	tagui_text = codecs.open('tagui.sikuli/tagui_sikuli.txt','wb',encoding='utf8')
...
tagui_output = open('tagui.sikuli/tagui_sikuli.out','wb')
tagui_output.write('[0] START')
tagui_output.close()

# initialise interface in-file before starting main loop
tagui_input = open('tagui.sikuli/tagui_sikuli.in','wb')
tagui_input.write('')
tagui_input.close()
...
while True:
	...
	try:
		tagui_input = open('tagui.sikuli/tagui_sikuli.in','r',encoding='utf-8')
