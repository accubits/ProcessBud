...
$marker_for_home_path = "var home_path = '" . str_replace("\\","/", drush_server_home()) . "';\n\n";
fwrite($output_file,$marker_for_home_path);

$marker_for_desktop_path = "var desktop_path = '" . str_replace("\\","/", drush_server_home()."/Desktop") . "';\n\n";
fwrite($output_file,$marker_for_desktop_path);

$marker_for_temp_path = "var temp_path = '" . str_replace("\\","/", sys_get_temp_dir()) . "';\n\n";
fwrite($output_file,$marker_for_temp_path);
...
chmod ($script . '.js',0666); // append url opening block below instead of throwing error
