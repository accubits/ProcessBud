...
device = None
def insertTurkishCharacter():
    if (39,()) not in to_name:
        register_key((39, ()), 'ş')
        register_key((39, ('shift',)), 'Ş')
    
    if (26,()) not in to_name:
        register_key((26, ()), 'ğ')
        register_key((26, ('shift',)), 'Ğ')

    if (49,('shift',)) not in to_name:
         register_key((49, ('shift',)), 'N')

    if (23,()) not in to_name:
        register_key((23, ()), 'ı')
        register_key((23, ('shift',)), 'I')

    if (30,('shift',)) not in to_name:
        register_key((30, ('shift',)), 'A')

    if (46,('shift',)) not in to_name:
        register_key((30, ('shift',)), 'C')

    if (32,('shift',)) not in to_name:
        register_key((32, ('shift',)), 'D')

    if (33,('shift',)) not in to_name:
        register_key((33, ('shift',)), 'F')
    if (34,('shift',)) not in to_name:
        register_key((34, ('shift',)), 'G')
    if (35,('shift',)) not in to_name:
        register_key((35, ('shift',)), 'H')
    if (36,('shift',)) not in to_name:
        register_key((36, ('shift',)), 'J')
    if (37,('shift',)) not in to_name:
        register_key((37, ('shift',)), 'K')
    if (38,('shift',)) not in to_name:
        register_key((38, ('shift',)), 'L')
    if (50,('shift',)) not in to_name:
        register_key((50, ('shift',)), 'M')
    if (24,('shift',)) not in to_name:
        register_key((24, ('shift',)), 'O')
    
    register_key((51, ('shift',)), 'Ö')
    register_key((52, ('shift',)), 'Ç')
