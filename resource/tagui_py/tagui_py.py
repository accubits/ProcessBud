...
tagui_output = open('tagui_py/tagui_py.txt','w',encoding='utf-8')
tagui_output.write('')
tagui_output.close()

# write to interface out-file to signal ready for inputs
tagui_output = open('tagui_py/tagui_py.out','w',encoding='utf-8')
tagui_output.write('[0] START')
tagui_output.close()

# initialise interface in-file before starting main loop
tagui_input = open('tagui_py/tagui_py.in','w',encoding='utf-8')
tagui_input.write('')
tagui_input.close()
